...
define( "PATREON_TEXT_OVER_BUTTON_1A", 'To view this content, you must upgrade your tier to %%tier_level%% or higher at <a href="%%creator_link%%" target="_blank">%%creator%% Patreon</a>' );
...
define( "PATREON_TEXT_OVER_BUTTON_3", 'Please <a href="https://www.patreon.com/settings/payment?utm_source=' . urlencode( site_url() ) . '&utm_medium=patreon_wordpress_plugin&utm_campaign=&utm_content=declined_payment_info_link&utm_term=" target="_blank" ref="nofollow">update</a> your Patreon payment method to access this post.' );
...
define( "PATREON_WORDPRESS_VERSION", '1.3.4' );
