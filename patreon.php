...
register_deactivation_hook(__FILE__, ['Patreon_Wordpress', 'deactivate']);
...
define('PATREON_DIRECT_UNLOCKS_NOT_ON', 'In order to use this feature, direct unlocks need to be turned on. Please refer to <a href="https://'.PATREON_HOST.'/apps/wordpress?utm_source='.urlencode(site_url()).'&utm_medium=patreon_wordpress_plugin&utm_campaign=&utm_content=direct_unlock_setting_notification_link&utm_term=">the developer documentation</a>. ');
...
define('PATREON_ADMIN_MESSAGE_V1_CLIENT_ATTEMPTING_V2_SETUP', 'Your site is using the old v1 version of Patreon connection. Since v1 apps can\'t be reconnected automatically, please visit <a href="https://'.PATREON_HOST.'/portal/registration/register-clients?utm_source='.urlencode(site_url()).'&utm_medium=patreon_wordpress_plugin&utm_campaign=&utm_content=v1_client_attempting_v2_setup&utm_term=" target="_blank">your app/clients page</a> at Patreon and delete the app/client that shows up for this site. After this, you can continue with setup.');
...
define('PATREON_CHECK_API_CONNECTION_COOLDOWN_S', 3 * 60);
