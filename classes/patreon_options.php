...
class Patreon_Options
{
    ...
    public function patreon_plugin_setup_page()
    {
       ...
       <form method="post" action="options.php">
        ...
        if (isset($cb_p6_a1)) {
            ?>Patron Plugin Pro <?php echo $cb_p6_a1->internal['version'];
            echo "\r\n";
        }
        ...
        if (isset($cb_p6)) {
            ?>Patreon Button, Widgets and Plugin <?php echo $cb_p6->internal['version'];
            echo "\r\n";
        }
