...
class Patreon_Metabox {

    public function patreon_plugin_meta_boxes_setup() {
        debug_to_console("HEYYYY");
    ...
    public function patreon_plugin_meta_boxes() {
        $screens = ['post', 'patreon-content'];
        foreach ($screens as $screen) {
            debug_to_console("DEBUUUUUG");
            add_meta_box(
